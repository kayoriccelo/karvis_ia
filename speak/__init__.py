...
from data.vocabulary.choices import (
    ...
    TYPE_VOCABULARY_WHAT_KNOWLEDGE_WANT_TEACH, TYPE_VOCABULARY_THANKS_FOR_THE_NEW_KNOWLEDGE,
    TYPE_VOCABULARY_I_FOUND_THE_FOLLOWING_INFORMATION, TYPE_VOCABULARY_CONFIRMS_THIS_INFORMATION_FOR_KNOWLEDGE,
    TYPE_VOCABULARY_WANT_INFORM_KNOWLEDGE, TYPE_VOCABULARY_INTRODUCE_YOURSELF, TYPE_VOCABULARY_I_HAPPY_TO_HELP
)
...
class Speak:
    ...
    def _applicate_frame_rate_audio(
        ...
        audio.seg.frame_rate = self.frame_rate
    ...
    def say_what_intent_you_want_create(self):
    ...
    def say_i_happy_to_help(self):
        return self._say_vocabulary(TYPE_VOCABULARY_I_HAPPY_TO_HELP)
